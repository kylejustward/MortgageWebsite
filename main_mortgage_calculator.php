        ...
        <div class="container">
            <div class="row">
				...
				<h1>Mortgage Calculator</h1>
					<form action = " main_mortgage_calculator.php " method = "POST"><br>
		
						  Morgage Amount:         <br> 
						  <input class="form-control" id="readonly" type="text" placeholder="<?php echo number_format($principleAmount, 2);?>" readonly><br>
      
						  Interest Rate:          <br>
						  <input class="form-control" id="readonly" type="text" placeholder="<?php echo number_format($interestRate, 2);?>" readonly><br>
						  
						  Length of Loan in Years:<br>
						  <input class="form-control" id="readonly" type="text" placeholder="<?php echo number_format($years, 2);?>" readonly><br>
						  
						  Monthly Payments:
						  <input class="form-control" id="readonly" type="text" placeholder="<?php echo number_format($monthlyPayments, 2);?>" readonly>
						  <br>
